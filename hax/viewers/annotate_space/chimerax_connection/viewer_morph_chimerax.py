...
from hax.viewers.annotate_space.chimerax_connection.viewer_salesman_solver import salesmanSolver
...
class FlexMorphChimeraX(QObject):
    ...
    def __init__(self, _z_space, _file_names, _path, _chimerax_binary):
        super(QObject, self).__init__()
        self.z_space = _z_space
        self.file_names = _file_names
        self.path = _path
        self.chimerax_binary = _chimerax_binary
    ...
    def openChimeraX(self, scriptFile):
        cmd = self.chimerax_binary + ' "%s"' % scriptFile
